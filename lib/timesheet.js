...
// Mirrors calculate() from rannikon-backend/src/routes/timesheet.js exactly.
...
export function blankIfZeroHours(value) {
  if (value == null || value === '0:00' || value === '0:0') return '';
  return value;
}
